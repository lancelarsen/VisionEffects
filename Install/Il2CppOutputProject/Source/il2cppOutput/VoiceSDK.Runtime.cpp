...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AppVoiceExperience_InitVoiceSDK_m32D292065C10F12806D615E70A52C3DE51A623B5 (AppVoiceExperience_t73F120132FB3DCEDD1AD48085A8A8D77419E60EF* __this, const RuntimeMethod* method) 
{
	...
	Wit_t7582060C53BB0428697BD46A2E58C7A814907503* V_0 = NULL;
	{
		...
		RuntimeObject* L_0 = __this->___voiceServiceImpl_7;
		V_0 = ((Wit_t7582060C53BB0428697BD46A2E58C7A814907503*)IsInstClass((RuntimeObject*)L_0, Wit_t7582060C53BB0428697BD46A2E58C7A814907503_il2cpp_TypeInfo_var));
	...
	}
	{
		...
		Wit_t7582060C53BB0428697BD46A2E58C7A814907503* L_2 = V_0;
		WitRuntimeConfiguration_t74ABC500731591BA8D99A1C88E1821020551D3B3* L_3 = __this->___witRuntimeConfiguration_5;
		NullCheck(L_2);
		Wit_set_RuntimeConfiguration_m1A5350CFD57C6598E99C034CC77994B07952DDAA(L_2, L_3, NULL);
	}

IL_0021:
	{
		// voiceServiceImpl.VoiceEvents = VoiceEvents;
		RuntimeObject* L_4 = __this->___voiceServiceImpl_7;
		VoiceEvents_tB9CCDD1C68F3A784600E7932935F705B17B8F1F5* L_5;
		L_5 = VoiceService_get_VoiceEvents_m1EF25EC82AED7FA30940ECDAB3C862526DD30188_inline(__this, NULL);
		NullCheck(L_4);
		InterfaceActionInvoker1< VoiceEvents_tB9CCDD1C68F3A784600E7932935F705B17B8F1F5* >::Invoke(4 /* System.Void Facebook.WitAi.IVoiceService::set_VoiceEvents(Facebook.WitAi.Events.VoiceEvents) */, IVoiceService_t01DAFEF167D1E0F15D70823D1305A2316BBF1180_il2cpp_TypeInfo_var, L_4, L_5);
		// }
		return;
	}
}
